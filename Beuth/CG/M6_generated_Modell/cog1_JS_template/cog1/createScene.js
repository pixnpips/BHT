...
function(exports, scenegraph, animation) {
	...
	function init() {
		...
		//var vladsphere= scenegraph.createNodeWithModel("vladsphere", "vladsphere", {scale:500});
		...
		//var Blender_Node= scenegraph.createNodeWithModel("MyBlenderModell", "MyBlenderModell", {scale:500});
		//Blender_Node.rotateTo([0,-0.75,0]);

		var generated= scenegraph.createNodeWithModel("generated", "generated", {scale:500});
		generated.rotate([10.64,-0.36,2.4]);
		return;
