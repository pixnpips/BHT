 ...
 */
 ...
 function(exports, shader, framebuffer, data) {
	  ...
	  */
	 /**DONE*/ function calcPlaneEquation(vertices, polygon, normal) {
		...
		// normal=data.calculateNormalForPolygon(vertices, polygon, normal);
		 ...
		 // START exercise Z-Buffer for Plane Equation

		 // Project first vertex (could be any) on normal.
		 // The result is the distance D of polygon plane to origin.
		
		 var vertx=vertices[polygon[0]][0];
		 var verty=vertices[polygon[0]][1];
		 var vertz=vertices[polygon[0]][2];
		
		D=-(vertx*A+verty*B+vertz*C);
