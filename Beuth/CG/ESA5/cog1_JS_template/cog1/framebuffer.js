...
define(["exports", "scene"], function(exports, scene) {
	...
	function init(_ctx, _bgColor) {
		...
		//console.log("framebuffer: " + width + " " +height); // Hier kann man sich die Höhe und Breite des framebuffers anzeigen lassen
	 ...
	 * @return true on pass.
	 */
	/**DONE*/function zBufferTest(x, y, z, color) { 
		...
		//Loggen der Werte , die interessieren-------------------------------------------------------------------------------//
		...
		*/
		...
		//console.log('Größe des Framebuffers: '+zBufSize+ ' Höhe: ' +height +'Breite: '+ width);
		//console.log('Xwert: '+ x +' Y-Wert: ' + y );	
		//console.log ('IndexZBUF: '+ indexZBuf + ' zBuf[indexZBuf]: '+ zBuf[indexZBuf] + 'Größe des Framebuffers: '+zBufSize)
		// Z-Buffer pixel starts a frame as undefined.
		//z=undefined;
		//console.log('Z-Wert: '+z);
		//console.log(zBuf[indexZBuf]);
		...
		//Erkenntnisse:
		//Die zBufsize ist zufällig genau width*heighth
		//X und Y Wert werden schon irgendwo durchlaufen, die brauchen wir nicht noch einmal aktiv loopen
